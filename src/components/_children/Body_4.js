    ...
    <div className="  bg-white pb-14 px-12 font-lato ">
      <div className=" w-full text-center md:text-justify text-xl leading-7 md:text-2xl lg:text-3xl">
        ...
        <p className=" font-bold ">
          Para mais informações sobre como patrocinar o Bloomberg Línea Summit
          2022, entre em contato através do
        </p>
        <p className=" font-bold ">
          e-mail:{" "}
          <span className=" text-primary-500 self-end ">
           ads@bloomberglinea.com
          </span>
        </p>
        <p className=" font-bold ">
          Informações gerais:{" "}
          <span className=" text-primary-500 self-end ">
            summit@bloomberglinea.com
          </span>
        </p>
      </div>
    </div>
